...
Context::Context()
{
    ...
    prop_request.flags.set(gs::PropagationFlags::VISIBILITY_CACHE, true);
    prop_request.flags.set(gs::PropagationFlags::IR_THRESHOLD, true);
    prop_request.flags.set(gs::PropagationFlags::IR_CACHE, false);
    prop_request.flags.set(gs::PropagationFlags::DIFFUSE_CACHE, false);
    prop_request.flags.set(gs::PropagationFlags::SAMPLED_IR, false);
